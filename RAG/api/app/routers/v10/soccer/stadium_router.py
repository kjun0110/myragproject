...
router = APIRouter(prefix="/api/v10/soccer/stadium", tags=["Stadium"])
...
async def upload_stadium_jsonl(
    ...
    """
    Stadium JSONL 파일을 업로드하여 첫 5개 행을 출력합니다.
    ...
    Returns:
        첫 5개 행의 데이터
    """
    logger.info("[ROUTER] Stadium 업로드 라우터 도달")
