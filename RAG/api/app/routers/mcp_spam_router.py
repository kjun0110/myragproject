...
router_dir = current_file.parent  # api/app/routers/
...
from app.domains.spam_classifier.models.base_model import (
    GateRequest,
    GateResponse,
    SpamAnalyzeRequest,
    SpamAnalyzeResponse,
...
async def spam_analyze_with_tool(request: SpamAnalyzeRequest):
    ...
    try:
        ...
        from app.domains.spam_classifier.agents import get_exaone_tool
