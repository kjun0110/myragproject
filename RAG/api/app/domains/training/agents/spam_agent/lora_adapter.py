...
spam_agent_dir = current_file.parent  # api/app/domains/training/agents/spam_agent/
agents_dir = spam_agent_dir.parent  # api/app/domains/training/agents/
training_dir = agents_dir.parent  # api/app/domains/training/
domains_dir = training_dir.parent  # api/app/domains/
app_dir = domains_dir.parent  # api/app/
api_dir = app_dir.parent  # api/

sys.path.insert(0, str(api_dir))

from app.domains.training.agents.spam_agent.load_model import load_exaone_model
from app.domains.training.agents.spam_agent.transform_dataset_utils import load_datasets
