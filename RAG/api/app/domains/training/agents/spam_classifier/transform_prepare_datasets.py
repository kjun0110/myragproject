...
spam_classifier_dir = current_file.parent  # api/app/domains/training/agents/spam_classifier/
agents_dir = spam_classifier_dir.parent  # api/app/domains/training/agents/
...
from app.domains.training.agents.spam_agent import (
    DataPreprocessor,
    DataSplitter,
    TokenizerUtils,
...
def main():
    ...
    print(f"\n사용 방법:")
    print(f"  from app.domains.training.agents.spam_agent import load_datasets")
