...
class ScheduleAgent:
    """Schedule 데이터를 정책 기반으로 처리하는 Agent."""
    ...
    def __init__(self):
        ...
        logger.info("[AGENT] ScheduleAgent 초기화")
    ...
    def _build_mcp(self) -> Any:
        ...
        mcp = FastMCP("Schedule Agent ExaOne")
        agent = self
    ...
    def _safe_root(self) -> Path:
        ...
        # schedule_agent.py 위치: api/app/domains/v10/soccer/spokes/agents/schedule_agent.py
