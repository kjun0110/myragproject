...
from training.agents.spam_classifier.load_model import load_koelectra_model
...
def train_lora_adapter(
    ...
    if output_dir is None:
        ...
        output_dir = (
            api_dir / "artifacts" / "koelectra" / "spam_adapter" / "koelectra-small-v3-discriminator-spam-lora" / timestamp
        )
    else:
...
def load_classification_dataset(
    ...
    if dataset_path is None:
        dataset_path = training_dir / "data" / "spam_classifier" / "koelectra"
